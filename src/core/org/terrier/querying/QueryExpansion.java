...
public class QueryExpansion implements PostProcess {
	...
	*/
	...
	{
		System.out.println("");
		System.out.println("In expandQuery method");
		System.out.println("");
		List terms = new List();
		String h=rq.getQueryID();
		int p=Integer.parseInt(h);
		System.out.println("Query ID : "+p);
		//FileReader fr = new FileReader("/home/irlplab/Documents/Share/Ishita/mallet/topic_2014/2014n_"+p+".txt");
		FileReader fr = new FileReader("/home/irlplab/Documents/Share/Ishita/mallet/topic_modelling_14_new/tf_idf_summ/new/2014new_"+p+".txt");
		...
		while( ( line=br.readLine() ) != null) {
			...
			for(int j=0;j<a.length;j++){
				System.out.print(a[j]+" "+ps.stem(a[j])+" ");	
				terms.add(ps.stem(a[j]));
			}	
			System.out.println("");
		}
		...
		for(FeedbackDocument doc : feedback)
		{
			expansionTerms.insertDocument(doc, terms);
		}
